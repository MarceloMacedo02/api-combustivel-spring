package br.com.zonesoftware.apicombustivel.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select().apis(RequestHandlerSelectors.basePackage("br.com.zonesoftware.controller"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API para controle de combustível",
				"Esta API é utilizada o Spring Boot ", "Versão 1.0",
				"https://www.*********",
				new Contact("Daniel", "/////", "daniel.tavares@xxxxxx.com"),
				"Permitido uso para xxxxxxx", "https://xxxxx.xxx", Collections.emptyList() // Vendor //
																										// Extensions
		);
	}
